...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<div class="container-fluid">
		...
		<div class="navbar-btn navbar-btn-right">
			<a class="btn btn-info update-pro" href="{{url('/trash')}}"><span>TRASH</span></a>
		...
		<tbody>
			...
			<tr>
				...
				{{-- <td>@foreach ($rd->costumer as $r)
									{{$r->nama_costumer}} <br>
				@endforeach</td> --}}
				<td><a href="{{url('/detail')}}<?php echo '/'.$rd->id ?>" class="btn btn-info">DETAIL</a> <a
						href="{{url('/get_update')}}<?php echo '/'.$rd->id ?>" class="btn btn-success">EDIT</a> <a
