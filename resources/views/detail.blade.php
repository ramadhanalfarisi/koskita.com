...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<div class="container-fluid">
		...
		<div class="navbar-btn navbar-btn-right">
			<a class="btn btn-info update-pro" href="{{url('/read')}}"> <span>HOME</span></a>
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo  $getDetail[0]->nama_kost?></td>
			</tr>
			<tr>
				<th scope="col">Alamat</th>
				<td><?php echo  $getDetail[0]->alamat?></td>
			</tr>
			<tr>
				<th scope="col">Harga</th>
				<td><?php echo  $getDetail[0]->harga?></td>
			</tr>
			<tr>
				<th scope="col">Fasilitas</th>
				<td>

					@foreach ($getDetail[0]->fasilitas as $fas)
			...
			<tr>
				...
				<td><img width="350px" src="{{ url('/file/'.$getDetail[0]->file) }}"></td>
			</tr>

			<tr>
				<td><a href="{{url('/get_update')}}<?php echo '/'.$getDetail[0]->id ?>" class="btn btn-success">EDIT</a>
				</td>
				<td><a href="{{url('/delete')}}<?php echo '/'.$getDetail[0]->id ?>" class="btn btn-danger"
