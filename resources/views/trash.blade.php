	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="{{url('/restore')}}<?php echo '/'.$rd->id ?>" class="btn btn-success"
						onclick="return confirm('Apakah Anda Ingin Me-restore Data Ini ?')">RESTORE</a> <a
						href="{{url('/forcedelete')}}<?php echo '/'.$rd->id ?>" class="btn btn-danger"
