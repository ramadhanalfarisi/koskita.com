	...
	<div class="panel">
		<div class="panel-body">
			<form action="{{url('/edit')}}" method="post" enctype="multipart/form-data">
				...
				<?php $no = 1 ?>
				@foreach ($fasilitas_kost as $fas)
				<label class="fancy-checkbox">
					<input type="checkbox" name="fasilitas[]" <?php foreach($get_wheref as $get){if($fas->id == $get->fasilitas_id) echo "checked = 'checked'";} ?> value="{{$fas->id}}">
				...
				<input type="hidden" name="file_lama" value="<?php echo $get_where[0]->file ?>" id="">
