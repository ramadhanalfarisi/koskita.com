...
<body>
	<div class="panel">
		<div class="panel-heading">
			<h3 class="panel-title">Tambah Kost</h3>
		</div>
		<div class="panel-body">
			<form action="{{url('/create')}}" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
				<input type="text" class="form-control" name="nama_kost" placeholder="Nama Kost"><br>
				<textarea class="form-control" name="alamat_kost" placeholder="Alamat Kost" rows="4"></textarea><br>
				<input type="text" class="form-control" name="harga" placeholder="Harga Kost"><br>
				...
				@endforeach
				<br>
				<input type="file" class="form-control" name="file" placeholder="Gambar"><br>
