			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
									<p class="h3">Login to your account</p>
							</div>
						<form class="form-auth-small" action="{{url('/go_login')}}" method="post">
							{{ csrf_field() }}
							    ...
							    <a href="{{url('/register')}}" class="btn btn-success btn-lg btn-block">REGISTER</a>
								<div class="bottom">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Login Kos-Kosan Kita</h1>
						</div>
					</div>
